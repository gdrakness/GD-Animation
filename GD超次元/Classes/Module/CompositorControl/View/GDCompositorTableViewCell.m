...
-(void)setModel:(GDCompositorPostsModel *)model{
    ...
    if (!model.sort) {
        NSLog(@"%@",model.bbsid);
        if ([model.bbsid isEqualToString:@"210451"] || [model.bbsid isEqualToString:@"179541"] || [model.bbsid isEqualToString:@"148459"] || [model.bbsid isEqualToString:@"213814"]) {
        ...
        }else if ([model.bbsid isEqualToString:@"80962"] || [model.bbsid isEqualToString:@"148973"] || [model.bbsid isEqualToString:@"217407"] || [model.bbsid isEqualToString:@"179541"]){
        ...
        }else if ([model.bbsid isEqualToString:@"148944"] || [model.bbsid isEqualToString:@"80967"] || [model.bbsid isEqualToString:@"204759"] || [model.bbsid isEqualToString:@"146528"]){
        ...
        }else if ([model.bbsid isEqualToString:@"81179"] || [model.bbsid isEqualToString:@"146528"] || [model.bbsid isEqualToString:@"146528"] || [model.bbsid isEqualToString:@"148973"]){
